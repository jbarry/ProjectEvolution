...
public class Pair<A, B> {
	...
	public static void main(String[] args) {
		...
		out.println(aList2.get(0).getFst() +
				" " + aList2.get(0).getSnd());*/
		Random r = new Random();
		LinkedList<Organism> orgsList = new LinkedList<Organism>();
		for (int i = 0; i < 5; i++)
			orgsList.add(new Organism(true, 5, r.nextInt(20), i));
		LinkedList<Organism> copyOrgs = (LinkedList<Organism>) orgsList.clone();
		System.out.println(copyOrgs.size());
	}
